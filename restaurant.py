...
lblInfo=Label(Tops,font=('helvetica',50,'bold'),text="ABHISEK'S RESTAURANT ",fg="Black",bd=10,anchor='w')
...
def Ref():
    ...
    CostofFries =CoFries * 80          #Cost of fries are defined here.
    CostofDrinks=CoD * 65              #Cost of drinks are defined here.
    CostofNoodles = CoNoodles* 90      #Cost of Noodles are defined here.
    CostofSoup = CoSoup * 140          #Cost of Soup are defined here.
    CostBurger = CoBurger* 100         #Cost of Burger are defined here.
    CostSandwich=CoSandwich * 100      #Cost of Sandwitches are defined here.
    ...
    bill = 'Bill Number = ' + str(randomRef) + '\n'+ 'Fries = '+ str(CostofFries) + '\n'+'Drinks = '+str(CostofDrinks) + '\n'+'Noodles = ' + str(CostofNoodles) + '\n'+'Soup = ' + str(CostofSoup) + '\n'+'Burger = ' + str(CostBurger) + '\n'+'Sandwitch = ' + str(CostSandwich) + '\n'+'Meals = ' + str(CostofMeal) +'\n'+'Total cost = ' + str(TotalCost) +'\n'+'Service Charge = ' + str(Ser_Charge) + '\n'+'Taxes = ' + str(PaidTax) + '\n' + 'Ammount Paid = ' + str(OverAllCost)

    invoice = tf.mktemp('.txt')

    open(invoice, 'w').write(bill)
